...
</li>`).join("")}const q=new b(".list a",{captionsData:"alt",captionDelay:250});async function w(){u+=1;try{const a=await p(c);i.insertAdjacentHTML("beforeend",m(a.hits))}catch(a){alert(a.message)}}
